	Computer_System u0 (
		.ci_initial_export               (<connected-to-ci_initial_export>),               //           ci_initial.export
		.cr_initial_export               (<connected-to-cr_initial_export>),               //           cr_initial.export
		.finish_render_export            (<connected-to-finish_render_export>),            //        finish_render.export
		...
		.max_iterations_export           (<connected-to-max_iterations_export>),           //       max_iterations.export
		...
		.pan_export                      (<connected-to-pan_export>),                      //                  pan.export
		.step_i_export                   (<connected-to-step_i_export>),                   //               step_i.export
		.step_r_export                   (<connected-to-step_r_export>),                   //               step_r.export
		...
		.zoom_export                     (<connected-to-zoom_export>),                     //                 zoom.export
		.zoom_out_export                 (<connected-to-zoom_out_export>),                 //             zoom_out.export
		.reset_mandel_export             (<connected-to-reset_mandel_export>)              //         reset_mandel.export
	);
